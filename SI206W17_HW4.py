...
## Your section day/time: Thursday 6:00pm
## Any names of people you worked with on this assignment: No
...
url_to_scope = 'http://www.nytimes.com'
html_text  = requests.get(url_to_scope).text
fileref = open("nytimes_data.html","w")
fileref.write(html_text)
fileref.close()

# The first part, write the code and save the file
